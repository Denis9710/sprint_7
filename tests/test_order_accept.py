...
class TestOrderAccept:
    ...
    def test_order_accept_success(self, courier_and_order):  # УДАЛЕНО: clean_courier, clean_order
        ...
        # УДАЛЕНО: clean_order(track_id)
        # УДАЛЕНО: clean_courier(courier_and_order['courier']['data'])

    @allure.title('Проверка ошибки при принятии заказа без id курьера')
    def test_order_accept_error_without_courier_id(self, new_order):  # УДАЛЕНО: clean_order
        ...
        # УДАЛЕНО: clean_order(new_order['track_id'])

    @allure.title('Проверка ошибки при принятии заказа с неверным id курьера')
    def test_order_accept_error_with_wrong_courier_id(self, new_order):  # УДАЛЕНО: clean_order
    ...
    def test_order_accept_error_without_order_id(self, new_courier):  # УДАЛЕНО: clean_courier
    ...
    def test_order_accept_error_with_wrong_order_id(self, new_courier):  # УДАЛЕНО: clean_courier
