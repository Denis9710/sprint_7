...
class TestOrderAccept:
    ...
    def test_order_accept_success(self, courier_and_order, clean_courier, clean_order):
        courier_id = courier_and_order['courier']['id']
        order_id = courier_and_order['order']['order_id']
        track_id = courier_and_order['order']['track_id']
    ...
    def test_order_accept_error_without_courier_id(self, new_order, clean_order):
    ...
    def test_order_accept_error_with_wrong_courier_id(self, new_order, clean_order):
